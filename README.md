...
Public privacy and support pages for the **Scam Llama** iOS app.

The iOS app is a simple, easy-to-read scam checker designed for everyone — especially seniors. Big buttons, plain language, and a "Read Out Loud" button on every result.
